% remap-keys(SECTION) | User Commands
%
% "March 27 2023"
...
remap-keys - program to do something

# SYNOPSIS

**remap-keys** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**remap-keys** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **remap-keys** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**remap-keys** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    remap-keys. See **foo.conf**(5) for further details.
...
**remap-keys** provides some return codes, that can be used in scripts:
